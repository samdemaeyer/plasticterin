    ...
    <div id="strijders">
          ...
          <div className="content">
            ...
            <Link to="/projects/wachten-op-n-oplossing" className="project-wrapper">
              <img
                ...
                src="/plasticterin/projects/MISSING"
                alt="wachten op ‘n oplossing"
              />
          ...
          <div className="content">
            ...
            <Link to="/projects/ik-hoop-dat-ge-goed-slaapt-vannacht" className="project-wrapper">
              <img
                className="project-thumb missing"
                src="/plasticterin/projects/MISSING"
                alt="ikhoopdatgegoedslaaptvannacht"
              />
      ...
      <section>
        ...
        <article className="article">
          <div className="content">
            <a
              href="https://www.schaliegasvrij.be/actie/ineos-will-fall.html"
              target="_blank"
            ...
            <a
              href="https://info.meiplasticvrij.be/"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="https://www.plasticsoupfoundation.org/"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
              <img
                ...
                src="/plasticterin/projects/strijders-17.png"
                alt="Plastic soup foundation"
              />
              Plastic soup foundation
            </a>
            <a
              href="https://enecocleanbeachcup.be/nl"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="https://zeroplasticrivers.com/"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="https://www.fairandsquare.be/shop"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="https://www.instagram.com/lowimpactmovement/?hl=nl"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
          ...
          <div className="content">
            <a
              href="https://alejandroduran.com/statement"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="https://plasticattack.co.uk/what-is-a-plastic-attack/"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="https://www.minimalantwerp.be"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="https://saudadesdeportugal.nl/plasticus-maritimus"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="/http://www.maartenvandeneynde.com/?rd_project=183&lang=en"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="http://www.jenfedrizzi.com/our-sophisticated-denial"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="https://www.stormkop.be/weef-wijven"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
          ...
          <div className="content">
            <a
              href="https://readymag.com/u477014252/twominutesofearth"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="https://www.extinctionrebellion.be/nl"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="https://www.laurafromthedesert.com"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
              <img
                className="project-thumb"
                src="/plasticterin/projects/strijders-22.png"
                alt="Laura from the dessert"
              />
              Laura from the dessert
            </a>
            <a
              href="https://www.fairphone.com/nl"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="https://www.river-cleanup.org/nl/world"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="https://www.instagram.com/trashworksdesign/?hl=nl"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="http://www.chrisjordan.com/gallery/rtn/#silent-spring"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="https://www.instagram.com/thamesplastic"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
            ...
            <a
              href="https://www.projectvortex.org/dianna-cohen"
              target="_blank"
              rel="noopener noreferrer"
              className="project-wrapper"
            >
